...
//     try {
//       const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/categories/1/Essential`, {
//         method: "PUT",
//         headers: {
...
//     try {
//       const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/categories/${userId}/${name}`, {
//         method: "PUT",
...
import React, { useState, useContext } from "react";
import { emailContext } from "../App";
import { Edit, Save, X, Plus, Info } from "lucide-react";
